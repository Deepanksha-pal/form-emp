...
const EmployeeForm = () => {
  ...
  const [errors, setErrors] = useState({}); // Add useState for errors
  ...
  const validateForm = () => {
    ...
    if (!formData.guardianNumber) newErrors.guardianNumber = "Guardian Number is required";
  ...
  if (!validateForm()) {
    ...
    formDataObj.append("g_address", formData.permanentAddress);
    ...
    <form className="space-y-4" onSubmit={handleSubmit}>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            className="mt-1 block w-full px-4 py-2 border border-green-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
          />
          {errors.phoneNumber && <p className="text-yellow-500 text-sm">{errors.phoneNumber}</p>}
        </div>
        <div>
          <label htmlFor="alternateNumber" className="block text-sm font-medium text-gray-600">
            Alternate Number
          </label>
          <input
            type="text"
            ...
            className="mt-1 block w-full px-4 py-2 border border-green-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
          />
          {errors.alternateNumber && <p className="text-yellow-500 text-sm">{errors.alternateNumber}</p>}
        </div>
      </div>

      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          <label htmlFor="currentAddress" className="block text-sm font-medium text-gray-600">
            Residential Address
          </label>
          <textarea
            name="currentAddress"
            ...
            className="mt-1 block w-full px-4 py-2 border border-green-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
          />
          {errors.currentAddress && <p className="text-yellow-500 text-sm">{errors.currentAddress}</p>}
        </div>
        <div>
          ...
          <textarea
            ...
            className="mt-1 block w-full px-4 py-2 border border-green-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
          />
          {errors.permanentAddress && <p className="text-yellow-500 text-sm">{errors.permanentAddress}</p>}
        </div>
      </div>

      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          <label htmlFor="guardianName" className="block text-sm font-medium text-gray-600">
            Guardian Name
          </label>
          <input
            type="text"
            ...
            className="mt-1 block w-full px-4 py-2 border border-green-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
          />
          {errors.guardianName && <p className="text-yellow-500 text-sm">{errors.guardianName}</p>}
        </div>
        <div>
          <label htmlFor="guardianNumber" className="block text-sm font-medium text-gray-600">
            Guardian Number
          </label>
          <input
            type="text"
            ...
            className="mt-1 block w-full px-4 py-2 border border-green-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
          />
          {errors.guardianNumber && <p className="text-yellow-500 text-sm">{errors.guardianNumber}</p>}
        </div>
        <div>
          ...
          <input
            ...
            className="mt-1 block w-full px-4 py-2 border border-green-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
          />
          {errors.relationship && <p className="text-yellow-500 text-sm">{errors.relationship}</p>}
        </div>
      </div>
      ...
      <div>
        ...
        <input
          ...
          className="mt-1 block w-full px-4 py-2 border border-green-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
        />
        {errors.image && <p className="text-yellow-500 text-sm">{errors.image}</p>}
      </div>

      <div>
        <label htmlFor="idProof" className="block text-sm font-medium text-gray-600">
        ...
        <input
          ...
          className="mt-1 block w-full px-4 py-2 border border-green-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
        />
        {errors.idProof && <p className="text-yellow-500 text-sm">{errors.idProof}</p>}
      </div>
      <div>
        ...
        <input
          ...
          className="mt-1 block w-full px-4 py-2 border border-green-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
        />
        {errors.token && <p className="text-yellow-500 text-sm">{errors.token}</p>}
      </div>
